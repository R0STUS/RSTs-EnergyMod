...
function on_update(x, y, z)
    if (tonumber(read(block.get(x + 1, y, z), "is-enabled-energy")) < 7 and tonumber(read(block.get(x - 1, y, z), "is-enabled-energy")) < 7 and tonumber(read(block.get(x, y + 1, z), "is-enabled-energy")) < 7 and tonumber(read(block.get(x, y - 1, z), "is-enabled-energy")) < 7 and tonumber(read(block.get(x, y, z + 1), "is-enabled-energy")) < 7 and tonumber(read(block.get(x, y, z - 1), "is-enabled-energy")) < 7) then
        block.set(x, y, z, block.index("rstem:wire_strong"))
    elseif (tonumber(read(block.get(x + 1, y, z), "is-enabled-energy")) == 11 or tonumber(read(block.get(x - 1, y, z), "is-enabled-energy")) == 11 or tonumber(read(block.get(x, y + 1, z), "is-enabled-energy")) == 11 or tonumber(read(block.get(x, y - 1, z), "is-enabled-energy")) == 11 or tonumber(read(block.get(x, y, z + 1), "is-enabled-energy")) == 11 or tonumber(read(block.get(x, y, z - 1), "is-enabled-energy")) == 11) then
